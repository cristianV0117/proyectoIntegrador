...
<div class="container mt-4 col-md-11" >
	<div class="card" >
		<div class="card-header" >
			<strong>Videos de instalación de los  S.O</strong>
		</div>
		<div class="card-body" >
			<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
			  <li class="nav-item">
			    <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Windows 10</a>
			  </li>
			  <li class="nav-item">
...
<script src="../publico/js/peticiones.js" type="text/javascript"></script>
</body>
</html>